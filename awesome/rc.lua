...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ " 🤖 ", " 🧭 ", " 🧑🏻‍💻 ", " 🎨 ", " 🗃️ ", " 📧 ", " 🖥️ ", " 🎞️ ", " 🕹️ " }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control"}, "f", function () awful.spawn("firefox") end,
              {description = "open a firefox", group = "application"}),          
    ...
    -- Prompt
    awful.key({ modkey }, "r", function () awful.spawn ("rofi -modi run,drun,window -show drun -show-icons -sidebar-mode") end,
